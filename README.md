...
[![Latest Release](https://img.shields.io/github/v/release/nedtaylor/atomstruc?sort=semver)](https://github.com/nedtaylor/atomstruc/releases "View on GitHub")
...
The atomstruc library can be obtained from the git repository.
